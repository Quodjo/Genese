...
<body>
  <div id="container">
		...
		<img class="responsive-img" src="../resources/images/404.jpg">

    <div class="card bordered z-depth-2" style="margin-right: 5%; width:35%; float: right;" id="failCard" >
