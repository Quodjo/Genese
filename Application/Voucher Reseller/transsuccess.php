...
<body>
  <div id="container">
    ...
    <div style="margin-right: 5%; width:40%; float: left;" id="checkCard" >
      <div class="card-content ">
        <form id ="indexPage" method="POST" action="">
         <div class="row">
           <div class="input-field col s12">
           <div class="valign-wrapper">
               <h2 style="margin-top: -6%; font-size: 4rem;  "><strong>GHS500</strong><h4 class="center" style="margin-top: -6%; padding-left: 0.25em;"> transfered to</h4></h1>
               </div>
               <div class="input-field col s12">
                 <h3 class = "center" style="margin-top: -5%; color: #000000;">JOHN DOE</h3>
